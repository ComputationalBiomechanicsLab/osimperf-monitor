...
packages="autoconf automake autotools-dev build-essential byacc cmake doxygen freeglut3-dev gfortran git liblapack-dev libopenblas-dev libpcre3 libpcre3-dev libssl-dev libtool libxi-dev libxmu-dev ninja-build openjdk-8-jdk patchelf pkg-config python3 python3-dev python3-numpy python3-setuptools swig texlive-latex-base curl tmux"
